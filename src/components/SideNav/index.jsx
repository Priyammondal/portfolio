    ...
    <div id="menuOverlay" onClick={handleSideNavOpenClose}>
      <div id="menuCanvas">
        ...
        <ul className="menuItems">
          <li className={sectionInView === "about" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li className={sectionInView === "experience" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li className={sectionInView === "skills" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li
            className={
              location.pathname === "/projects" || sectionInView === "projects"
                ? "active"
                : ""
            }
          >
          ...
          <li className={sectionInView === "blogs" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li className={sectionInView === "activity" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li className={sectionInView === "contact" ? "active" : ""}>
            <a
              className="menuItem"
              onClick={() => {
          ...
          <li>
            <a className="menuItem" href={resume} download>
              Resume
            </a>
          </li>
        </ul>
